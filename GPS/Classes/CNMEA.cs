...
namespace AgOpenGPS
{
    public class CNMEA
    {
        ...
        public double latExtern = 0;
        public double lonExtern = 0;
        public bool neuExtern = false;
        ...
        public void ConvertWGS84toMetersPerDegree(double Lat, double Lon, out double Northing, out double Easting)
        {

            Northing = (111132.92 - 559.82 * Math.Cos(2.0 * Lat * 0.01745329251994329576923690766743) + 1.175
            * Math.Cos(4.0 * Lat * 0.01745329251994329576923690766743) - 0.0023
            * Math.Cos(6.0 * Lat * 0.01745329251994329576923690766743))*(Lat);

            Easting = (111412.84 * Math.Cos(Lat * 0.01745329251994329576923690766743) - 93.5
            * Math.Cos(3.0 * Lat * 0.01745329251994329576923690766743) + 0.118
            * Math.Cos(5.0 * Lat * 0.01745329251994329576923690766743))*(Lon);
