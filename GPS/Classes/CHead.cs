...
namespace AgOpenGPS
{
    public partial class CBoundary
    {
        ...
        {
            if (mf.vehicle.isHydLiftOn && mf.pn.speed > 0.3)// && mf.autoBtnState == FormGPS.btnStates.Auto)
            {
                if (isToolInHeadland)
                {
                    mf.p_239.pgn[mf.p_239.hydLift] = 2;// Auf
                ...
                {
                    mf.p_239.pgn[mf.p_239.hydLift] = 1;// Ab
                    if (mf.sounds.isHydLiftChange != isToolInHeadland)
                    {
            ...
            {
                mf.p_239.pgn[mf.p_239.hydLift] = 0; // deaktiviert
            }
        }
