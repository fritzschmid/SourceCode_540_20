...
namespace AgOpenGPS
{
    public partial class FormSteer : Form
    {
        ...
        private void FormSteer_Load(object sender, EventArgs e)
        {
            ...
            mf.vehicle.steerSpeedFaktor = Properties.Settings.Default.setSteerSpeedFaktor;
            hsbarSpeedFaktor.Value = Properties.Settings.Default.setSteerSpeedFaktor;
            lblSpeedFaktor.Text = hsbarSpeedFaktor.Value.ToString();
            ...
            lblSideHillComp.Text = Properties.Settings.Default.setAS_sideHillComp.ToString();

            hsbStPpMix.Value = Properties.Settings.Default.setStPpMix;
            lblStPpMix.Text = hsbStPpMix.Value.ToString();
 
            hsbHoldLine.Value = Properties.Settings.Default.setHoldLine;
            lblHoldLine.Text = hsbHoldLine.Value.ToString();
        ...
        private void hsbarSideHillComp_Scroll(object sender, ScrollEventArgs e)
        {

        }

        private void hsbarSpeedFaktor_ValueChanged(object sender, ScrollEventArgs e)
        {
            Properties.Settings.Default.setSteerSpeedFaktor = hsbarSpeedFaktor.Value;
            mf.vehicle.steerSpeedFaktor = (Int16)Properties.Settings.Default.setSteerSpeedFaktor;
            lblSpeedFaktor.Text = hsbarSpeedFaktor.Value.ToString();

        }

        private void hsbStPpMix_ValueChanged(object sender, ScrollEventArgs e)
        {
            Properties.Settings.Default.setStPpMix = hsbStPpMix.Value;
            Properties.Settings.Default.Save();
            mf.vehicle.steerStPpMix= (double)hsbStPpMix.Value / 10;
            lblStPpMix.Text = hsbStPpMix.Value.ToString();
        }

        private void hsbHoldLine_ValueChanged(object sender, ScrollEventArgs e)
        {
            Properties.Settings.Default.setHoldLine = hsbHoldLine.Value;
            mf.gyd.testRegler = (double)Properties.Settings.Default.setHoldLine / 10;
            lblHoldLine.Text = hsbHoldLine.Value.ToString();
        }
