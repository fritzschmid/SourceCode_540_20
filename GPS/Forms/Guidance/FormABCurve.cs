...
namespace AgOpenGPS
{
    public partial class FormABCurve : Form
    {
        ...
        private void FormABCurve_Load(object sender, EventArgs e)
        {
            ...
            numUDKurGlattWert1.Value = Properties.Settings.Default.setKurGlattWert;
            chkKurveGlaetten1.Checked = Properties.Settings.Default.setKurGlattJaNein;
        }
        ...
        private void btnListUse_Click(object sender, EventArgs e)
        {
            ...
            if (lvLines.SelectedItems.Count > 0)
            {
                ...
                mf.yt.ResetYouTurn();
                if (chkKurveGlaetten1.Checked)
                {
                    decimal dwert = numUDKurGlattWert1.Value;
                    int wert = Decimal.ToInt32(dwert);
                    //SmoothAB(wert);
                    mf.curve.SmoothAB(wert * 2);
        ...
        private void btnKurGlattMinus1_Click(object sender, EventArgs e)
        {
            decimal wert =  numUDKurGlattWert1.Value;
            if (wert > 0) { wert--; }
            numUDKurGlattWert1.Value = wert;
            Properties.Settings.Default.setKurGlattWert = wert;
        }

        private void btnKurGlattPlus1_Click(object sender, EventArgs e)
        {
            decimal wert = numUDKurGlattWert1.Value;
            if (wert < 99) { wert++; }
            numUDKurGlattWert1.Value = wert;
        ...
        private void chkKurveGlaetten1_CheckedChanged(object sender, EventArgs e)
        {
            if (chkKurveGlaetten1.Checked)
            {
                Properties.Settings.Default.setKurGlattJaNein =true;
            }
            else
            {
                Properties.Settings.Default.setKurGlattJaNein = false;
            }
        }
    }
}