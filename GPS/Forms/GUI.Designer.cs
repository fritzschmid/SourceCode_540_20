...
namespace AgOpenGPS
{
    ...
    {   
        private string VersionFS = "v5.4 20";
        //ABLines directory
        ...
        public Color colorBerechnungslinie1;
        public Color colorBerechnungslinie2;
        ...
        private void tmrWatchdog_tick(object sender, EventArgs e)
        {
            ...
            if (displayUpdateThreeSecondCounter != threeSeconds)
            {
                ...
                {
                    double distanz = distanzABLine1.RechneDistanzVonRefLine();
                    lblDistanzLine1.Text = distanz.ToString("0.00") + "m: " + distanzABLine1.desName;
                    lblDistanzLine1.Visible = true;
                }
                else
                {
                    lblDistanzLine1.Visible = false;
                }
                if (distanzABLine2.isABLineSet)
                {
                    double distanz = distanzABLine2.RechneDistanzVonRefLine();
                    lblDistanzLine2.Text = distanz.ToString("0.00") + "m: " + distanzABLine2.desName;
                    lblDistanzLine2.Visible = true;
                }
                else
                {
                    lblDistanzLine2.Visible = false;
                }
            ...
            if (displayUpdateOneSecondCounter != oneSecond)
            {
                ...
                if (isAutoSteerBtnOn)
                {
                    btnAutoSteer.Text = (p_254.pgn[p_254.status]).ToString();
                }
        ...
        {            //metric settings
            ...
            btnChangeMappingColor.Text = VersionFS;//Application.ProductVersion.ToString(CultureInfo.InvariantCulture);
            ...
            vehicle.steerSpeedFaktor = (Int16)Properties.Settings.Default.setSteerSpeedFaktor;
            vehicle.steerStPpMix = (double)Properties.Settings.Default.setStPpMix /10;
            gyd.testRegler= (double)Properties.Settings.Default.setHoldLine / 10;
            vehicle.steerOnDist = (double)Settings.Default.setSteerOnDist / 2;
            vehicle.steerOffDist = (double)Settings.Default.setSteerOffDist / 2;
            ...
            {
                btnStanleyPure.Image = Resources.Con_VehicleMenu;
            }
        ...
        public void SwapDayNightMode()
        {
            ...
            btnStanleyPure.ForeColor = Color.Fuchsia;
        ...
        private void oglMain_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (point.X > centerLeft - 40 && point.X < centerLeft + 40 && point.Y > centerUp - 60 && point.Y < centerUp + 60)
                {
                    ...
                    headingOK = 0;// fuer kompasabgleich reverse direction
                    toolPos.heading = fixHeading;// Trailer strecken
                    return;
                }
