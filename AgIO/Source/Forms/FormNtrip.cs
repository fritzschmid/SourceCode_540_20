...
namespace AgIO
{
    public partial class FormNtrip : Form
    {
        ...
        private void FormNtrip_Load(object sender, EventArgs e)
        {
            ...
            nudLonKorr1.Value = (decimal)Properties.Settings.Default.setNtripLonKorr;
            nudLatKorr1.Value = (decimal)Properties.Settings.Default.setNtripLatKorr;
            nudHoeheKorr1.Value = (decimal)Properties.Settings.Default.setNtripHeightKorr;
        ...
        private void btnSerialOK_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.setNtripLonKorr = (double)nudLonKorr1.Value;
            Properties.Settings.Default.setNtripLatKorr = (double)nudLatKorr1.Value;
            Properties.Settings.Default.setNtripHeightKorr = (double)nudHoeheKorr1.Value;
            
            mf.lonKorr= (double)nudLonKorr1.Value;
            mf.latKorr= (double)nudLatKorr1.Value;
        ...
        {
            if (tboxUserPassword.PasswordChar == '*' & tboxUserPassword.Text == "")
            {
                tboxUserPassword.PasswordChar = '\0';
                tboxUserName.PasswordChar = '\0';
                btnPassPassword.Text = "(O)";
            }
            else
            {
                tboxUserPassword.PasswordChar = '*';
                tboxUserName.PasswordChar = '*';
                btnPassPassword.Text = "(-)";
            }
