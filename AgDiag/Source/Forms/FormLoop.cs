...
namespace AgDiag
{
    public partial class FormLoop : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //
            if ((asData.pgn[asData.sc9to16] & 1) == 1) lblSection9.BackColor = Color.Green;
            else lblSection9.BackColor = Color.Red;
            if ((asData.pgn[asData.sc9to16] & 2) == 2) lblSection10.BackColor = Color.Green;
            else lblSection10.BackColor = Color.Red;
            if ((asData.pgn[asData.sc9to16] & 4) == 4) lblSection11.BackColor = Color.Green;
            else lblSection11.BackColor = Color.Red;
            if ((asData.pgn[asData.sc9to16] & 8) == 8) lblSection12.BackColor = Color.Green;
            else lblSection12.BackColor = Color.Red;

            if ((asData.pgn[asData.sc9to16] & 16) == 16) lblSection13.BackColor = Color.Green;
            else lblSection13.BackColor = Color.Red;
            if ((asData.pgn[asData.sc9to16] & 32) == 32) lblSection14.BackColor = Color.Green;
            else lblSection14.BackColor = Color.Red;
            if ((asData.pgn[asData.sc9to16] & 64) == 64) lblSection15.BackColor = Color.Green;
            else lblSection15.BackColor = Color.Red;
            if ((asData.pgn[asData.sc9to16] & 128) == 128) lblSection16.BackColor = Color.Green;
            else lblSection16.BackColor = Color.Red;
            // ende sections
            ...
            lblFG1.Text = "TL=" + (asData.pgn[asData.status] & 64).ToString();
            lblHydLift1.Text = "Hw=" + (asData.pgn[asData.status] & 16+32).ToString();
            //von MaschinenDaten
            //lblFG1.Text = "FG=" + maData.pgn[maData.tram].ToString();
            //lblHydLift1.Text = "H=" + maData.pgn[maData.hydLift].ToString();
        ...
        private void lblDefaultSends_Click(object sender, EventArgs e)
        {
